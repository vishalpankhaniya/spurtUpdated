...
const manufactureController = require('./controller/manufacture.controller');
...
const settingController = require('./controller/settings.controller');
const zoneController = require('./controller/zone.controller');
const emailTempController = require('./controller/emailTemp.controller');
...
const wishListController = require('./controller/customerwishlist.controller');
...
//Routes for Sellers API

app.post('/api/seller/add-seller', sellerController.createSeller);
app.get('/api/seller/seller-list', sellerController.sellerList)
app.put('/api/seller/update-seller/:id', sellerController.updateSeller);
app.delete('/api/seller/delete-seller/:id', sellerController.removeSeller);
app.post('/api/seller/login', sellerController.sellerLogin);
